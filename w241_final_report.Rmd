...
Our last model is a fully saturated model used to evaluate the heterogeneous effects of resume type and job type. This model showed a `r round(cj[1],3)`% (CI: `r round(cj[1]-1.96*robust_se_j[1],3)`%,`r round(cj[1]+1.96*robust_se_j[1],3)`%) response rate for Data Scientist jobs with the control resume, a `r round(cj[2],3)`% (CI: `r round(cj[2]-1.96*robust_se_j[2],3)`%,`r round(cj[2]+1.96*robust_se_j[2],3)`%) response rate for Data Scientist jobs with the treatment resume, a `r round(cj[3],3)`% (CI: `r round(cj[3]-1.96*robust_se_j[3],3)`%,`r round(cj[3]+1.96*robust_se_j[3],3)`%) response rate for Data Analyst jobs with the control resume, and a `r round(cj[4],3)`% (CI: `r round(cj[4]-1.96*robust_se_j[4],3)`%,`r round(cj[4]+1.96*robust_se_j[4],3)`%) response rate for Data Analyst jobs with the treatment resume. This model highlights a disappointing result, we received no positive responses for any Data Scientist positions. However by evaluating the heterogeneous effects of resume type and job type, we have uncovered that a control resume or treatment resume that was sent to a Data Analyst position had a statistically significant increase compared to a control resume sent to a Data Scientist position. This agrees with our last model which showed that there was a statistically significant difference between Data Scientist and Data Analyst positions.
